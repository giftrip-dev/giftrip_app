...
/// 페이징 응답
class TesterPageResponse {
  final List<TesterModel> items;
  final PageMeta meta;
  ...
  factory TesterPageResponse.fromJson(Map<String, dynamic> json) {
    final itemsJson = json['items'] as List<dynamic>;
    return TesterPageResponse(
      items: itemsJson.map((e) => TesterModel.fromJson(e)).toList(),
